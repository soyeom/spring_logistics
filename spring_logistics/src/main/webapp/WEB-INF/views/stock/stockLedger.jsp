				...
				<div class="filters">
					...
					<div class="filters-row">
						...
						<div class="filters-count">
							...
							<div class="filters-value">
								<input type="date" id="searchPeriodStart"
									name="searchPeriodStart"> <span>~</span> <input
									type="date" id="searchPeriodEnd" name="searchPeriodEnd">
							</div>
						</div>
						<div class="filters-count">
						...
						<div class="filters-count">
							...
							<div class="filters-value">
								<input type="text" id="itemName" name="itemName"> <img
									id="search-item-name-btn"
						...
						<div class="filters-count">
							...
							<div class="filters-value">
								<input type="text" id="itemId" name="itemId"> <img
									id="search-item-id-btn"
									src="https://cdn-icons-png.flaticon.com/512/16799/16799970.png"
									alt="search" class="search-icon">
							</div>
						</div>
